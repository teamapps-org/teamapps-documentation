...
public class ComboBoxTemplateDecider implements Example {
    ...
    public void onSessionStart(SessionContext sessionContext) {
        List<Animal> animalList = List.of(
                ...
                new Animal(AntuIcon.APP_WINUSBGUI_ICON_48, "Simba", AnimalSpecies.LION, 120, null, "Large carnivorous cat", Color.YELLOW),
                new Animal(AntuIcon.APP_BZR_ICON_64_48, "Sonya", AnimalSpecies.BEAR, 150, null, "Carnivorous mammal", Color.BROWN));
